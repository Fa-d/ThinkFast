...
object Constants {
    ...
    // Database
    const val DATABASE_NAME = "thinkfaster_db"
    const val DATABASE_VERSION = 1
    const val EVENT_BATCH_SIZE = 10
    const val EVENT_FLUSH_INTERVAL = 5000L  // 5 seconds

    // Notifications
    const val CHANNEL_ID = "thinkfaster_monitoring"
    ...
    // Service Actions
    const val ACTION_START_MONITORING = "dev.sadakat.thinkfaster.START_MONITORING"
    const val ACTION_STOP_MONITORING = "dev.sadakat.thinkfaster.STOP_MONITORING"
    const val ACTION_SESSION_RESUMED = "dev.sadakat.thinkfaster.SESSION_RESUMED"
    ...
    // Preferences
    const val PREF_NAME = "thinkfaster_prefs"
