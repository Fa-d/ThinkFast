...
import dev.sadakat.thinkfast.data.local.database.dao.ContentEffectivenessStats
import dev.sadakat.thinkfast.data.local.database.dao.UserChoiceStat
 ...
 */
fun ContentEffectivenessStats.toDomainContentStats(): dev.sadakat.thinkfast.domain.model.ContentEffectivenessStats {
    return dev.sadakat.thinkfast.domain.model.ContentEffectivenessStats(
        contentType = contentType,
        total = total,
...
fun List<ContentEffectivenessStats>.toDomainContentStats(): List<dev.sadakat.thinkfast.domain.model.ContentEffectivenessStats> {
