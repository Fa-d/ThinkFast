...
- [ ] Scheduled 45-minute slot (30 min interview + 15 min buffer)
...
- Feel free to be brutally honest - critical feedback is the most valuable
...
## Part 2: First Impression & Onboarding (5 minutes)
...
- If waited: Why? What would have motivated you to do it sooner?
- Listen for: Onboarding effectiveness

**Q6:** On a scale of 1-10, how easy was it to get started?
- If <8: What would have made it easier?

---

## Part 3: Daily Usage & Value (10 minutes)
...
- Follow-up: Why is that one valuable to you?
- Listen for: Core value proposition

**Q9:** Let's talk about the intervention screens - the ones that pop up when you open Facebook or Instagram. What's your honest reaction to them?
- Probes:
  - Do you read them, or just tap through?
  - Have they ever made you change your mind about using the app?
...
## Part 4: Pain Points & Friction (8 minutes)
...
**Q14:** Is there anything you tried to do but couldn't figure out how?
- Listen for: UX gaps, missing features

**Q15:** What would you REMOVE from the app if you could?
- Listen for: Unnecessary complexity

**Q16:** On a scale of 1-10, how annoying are the intervention screens?
- If >5: What would make them less annoying but still effective?
- Listen for: Balance between friction and annoyance

---

## Part 5: Feature Requests & Improvements (7 minutes)
...
## Part 6: Monetization (8 minutes)

**Goal:** Understand willingness to pay and pricing expectations.
...
**Q22:** Would you prefer a monthly subscription or a one-time purchase?
- If one-time: How much would you pay?
- Listen for: Payment model preference

**Q23:** What features would need to be "premium" for you to pay?
...
**Thank You:**
```
This has been incredibly valuable - thank you so much for your time and honesty.

Your feedback will directly shape what we build next. I'll keep you updated on how we use your suggestions.

As a thank you:
- [Offer: Early access, discount code, acknowledgment, etc.]
- Would you like to be credited in our "Special Thanks" section when we launch? (Optional)
...
Within 1 hour of the interview:

1. **Document Insights:**
   - Top 3 quotes (verbatim)
   - Key pain points
   - Feature requests
   - Willingness to pay (Y/N and price point)
   - NPS score (0-10)

2. **Update USER_RESEARCH.md:**
...
3. **Send Thank You Email:**
   ...
   Just wanted to say thanks again for the interview today. Your feedback was incredibly helpful, especially [mention 1-2 specific insights].

   I'll keep you posted as we implement your suggestions!
...
## Key Metrics to Track Across Interviews

After 5-10 interviews, analyze:

### Quantitative:
- Average NPS: _____ (Target: >40)
- % willing to pay: _____ (Target: 30%+)
- Average price willingness: $_____
- Monthly vs one-time preference: _____ vs _____
...
**Core Value Proposition (What do users NEED?):**
- _____
- _____

**Premium Feature Ideas (What would they PAY for?):**
- _____
- _____

**User Personas Validation:**
- Does "Aware Scroller" persona match? Y/N
- New persona insights: _____
...
✅ Ask "Why?" at least 3 times to get to root motivation
...
- Helpful or annoying: _____
- Dismissal rate: _____
- Suggestions: _____
